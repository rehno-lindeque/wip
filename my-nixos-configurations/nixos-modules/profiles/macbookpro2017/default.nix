...
in {
  ...
  config = lib.mkIf cfg.enable {
    ...
    # Enable ssh so that I can work on the laptop remotely
    services.openssh = {
      enable = true;
    ...
    users.users.me.openssh.authorizedKeys.keys = [
      ...
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIJkde7PU92uQluyO7OSKTqSoreWxibJhM/cOmpJNAiIC me@macbookpro2025"
    ];
